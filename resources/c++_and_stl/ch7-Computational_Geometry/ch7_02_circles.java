class ch7_02_circles {
  ...
  void run() {
    ...
    System.out.printf("Length of arc (central angle = 30 degrees) = %.2f\n", 30.0 / 360.0 * c);
    System.out.printf("Length of chord (central angle = 30 degrees) = %.2f\n",
      Math.sqrt((2 * r * r) * (1 - Math.cos(DEG_to_RAD(30.0)))));
    System.out.printf("Area of sector (central angle = 30 degrees) = %.2f\n", 30.0 / 360.0 * A);
    // System.out.printf("Area of segment (30 degrees) = %.2f\n", 0.0); // subtract the area of the corresponding sector with the area of an Isosceles Triangle with sides: r, r, and Chord-length

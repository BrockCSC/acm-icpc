...
int main() {
  ...
  // Graph in Figure 4.1 (and Figure 4.4)
  9
  1 1 0
  3 0 0 2 0 3 0
  2 1 0 3 0
  ...
  // Example of directed acyclic graph in Figure 4.3 (for toposort)
  8
  2 1 0 2 0
  2 2 0 3 0
  2 3 0 5 0
  ...
  // Left graph in Figure 4.5/4.6/4.7
  6
  1 1 0
  3 0 0 2 0 4 0
  1 1 0
  ...
  // Right graph in Figure 4.5/4.6/4.7
  6
  1 1 0
